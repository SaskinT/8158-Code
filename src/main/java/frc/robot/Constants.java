...
public final class Constants {
    public static final class FuelConstants {
        ...
        public static final double INDEXER_INTAKING_PERCENT = -0.2;
        public static final double INDEXER_LAUNCHING_PERCENT = 0.2;
        public static final double INDEXER_SPIN_UP_PRE_LAUNCH_PERCENT = -0.2;
        public static final double INTAKE_INTAKING_PERCENT = 0.2;
        public static final double LAUNCHING_LAUNCHER_PERCENT = 0.2;
        public static final double INTAKE_EJECT_PERCENT = -0.2;
    ...
    public static final class ClimbConstants {
        ...
        public static final double CLIMBER_MOTOR_DOWN_PERCENT = -0.2;
        public static final double CLIMBER_MOTOR_UP_PERCENT = 0.2;
    }
