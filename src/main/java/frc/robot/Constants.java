...
public final class Constants {
    public static final class FuelConstants {
        ...
        public static final double INDEXER_LAUNCHING_PERCENT = -0.75;
        public static final double INDEXER_SPIN_UP_PRE_LAUNCH_PERCENT = -0.9;
        public static final double INTAKE_INTAKING_PERCENT = 0.7; 
        public static final double LAUNCHING_LAUNCHER_PERCENT = 0.9;
    ...
    public static final class HubConstants {
        ...
        public static final double hubX = 4.0;
        public static final double hubY = 4.5;
        public static final Translation2d hubTranslation = new Translation2d(hubX,hubY);
    }
}